...
import UsersTable from '@/components/tables/BasicTableOne';
...
export default function BasicTables() {
  ...
  // Filter tableData to show only active users
  const activeUsers = tableData.filter((user) => user.isActive);
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        ...
        >
          <UsersTable tableData={activeUsers} setTableData={setTableData} />
        </ComponentCard>
      </div>
    </div>
  );
